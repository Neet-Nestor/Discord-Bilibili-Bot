...
class Config:
    ...
    def __init__(self, config_file):
        ...
        self.bilibili_quality = config.getint('MusicBot', 'BilibiliQuality', fallback=ConfigDefaults.bilibili_quality)
    ...
    def run_checks(self):
        ...
        if not self._login_token:
            raise HelpfulError(
                ...
                "See https://github.com/Neet-Nestor/Discord-Bilibili-Bot for info.",
                preface=self._confpreface
            )
